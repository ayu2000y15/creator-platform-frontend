...
export default function EditProfilePage() {
  const { user, loading, enableTwoFactor, disableTwoFactor, updateProfile, changePassword } = useAuth()
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfileError(error.response?.data?.message || "プロフィールの更新に失敗しました")
    } finally {
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>セキュリティのため定期的にパスワードを変更することをお勧めします</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>アカウントのセキュリティを強化するための設定</CardDescription>
            </CardHeader>
            <CardContent>
